...
const I18N = {
  zh: {
    ...
    sysAutoPrecision: '按日期字符串精度自动选择',
    sysAutoPrecisionDesc: '复制日期唤起时，解析结果始终填入左侧日期输入框；「按字符串精度」随小数位自动切换精度页（.123→毫秒、.123456→微秒、.123456789→纳秒、无小数→秒），「跟随默认TAB页」则停在上方设置',
    sysAutoPrecisionAuto: '按字符串精度',
    sysAutoPrecisionDefault: '跟随默认TAB页',
    ...
    sysUsNsRandom: '随机',
    sysLang: '界面语言', sysLangDesc: '选择界面显示语言',
    sysLangZh: '中文', sysLangEn: 'English',
    hotkeyTitle: '全局快捷键', hotkeyDesc: '任意位置呼出窗口（需后台运行）',
    hotkeyEnable: '启用全局快捷键', hotkeyCurrent: '当前快捷键', hotkeyDisabled: '已禁用',
    hotkeyRecord: '点击后按下新快捷键', hotkeyReset: '恢复默认',
    hotkeySaved: '快捷键已保存', hotkeyConflict: '快捷键注册失败（可能被其他程序占用）',
    hotkeyNoModifier: '请至少包含 Ctrl/Alt/Shift 组合键',
    donate: '支持开发者',
    donateTitle: '支持开发者',
...
en: {
    ...
    sysAutoPrecision: 'Auto-select precision from date string',
    sysAutoPrecisionDesc: 'When a date string invokes the plugin, parsed values always fill the date inputs; "By string precision" follows the sub-second digits (.123→ms, .123456→us, .123456789→ns, none→sec), "Follow default tab" stays on the tab above',
    sysAutoPrecisionAuto: 'By string precision',
    sysAutoPrecisionDefault: 'Follow default tab',
    ...
    sysLang: 'Language', sysLangDesc: 'Choose the interface language',
    sysLangZh: '中文', sysLangEn: 'English',
    hotkeyTitle: 'Global Hotkey', hotkeyDesc: 'Summon the window from anywhere (background running required)',
    hotkeyEnable: 'Enable global hotkey', hotkeyCurrent: 'Current hotkey', hotkeyDisabled: 'Disabled',
    hotkeyRecord: 'Click, then press the new shortcut', hotkeyReset: 'Reset',
    hotkeySaved: 'Hotkey saved', hotkeyConflict: 'Hotkey registration failed (may be used by another app)',
    hotkeyNoModifier: 'Include at least Ctrl/Alt/Shift',
